  ...
  <div class="form-register">
    ...
    <form class="form" action="" method="POST">
      ...
      <div class="flex-column">
        ...
        @enderror
          ...
          <div class="flex-column">
            ...
            <div class="inputForm">
              ...
              <input type="password" class="input" placeholder="Enter your Password" name="confirmpassword">
       ...
       <p class="p">Don't have an account?<span class="span"><a href="{{route('login.index')}}">Login</a></span> 
