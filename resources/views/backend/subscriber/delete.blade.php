...
<form action="{{ route('subscriber.destroy', $sub->id) }}" method="post" class="box">
    @csrf
            ...
            <div class="col-lg-5">
                <div class="panel-head">
                    ...
                    <div class="panel-description">
                        <p>{{__('messages.areyousure')}} <span class="text-danger">{{$sub->name}}</span></p>
                        ...
                        <div class="row mb10">
                            <div class="col-lg-12">
                                <div class="form-row">
                                    ...
                                    <input type="text" readonly name="name" value="{{old('name', ($sub->email) ?? '')}}" class="form-control" placeholder="" autocomplete="off">
                                </div>
                            </div>
